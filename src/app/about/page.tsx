...
const content = [
  ...
  { key: 3, Heading: "Safety & Respect", data: "We are committed to ensuring that [Your Website Name] remains a positive space. While we allow anonymous messaging, we have strict guidelines against hate speech, harassment, or harmful behavior. We encourage users to communicate respectfully and responsibly."}
]
